        ...
        <div class="col-lg-4">
          <div class="card overflow-hidden bg-success text-white">
            <div class="card-body p-4">
              ...
              <div class="row align-items-center">
                <div class="col-8">
                  <h4 class="fw-semibold mb-3 text-white">{{ $tagihanLunas }} Pelanggan</h4>
                </div>
                <div class="col-4">
                  <div class="d-flex justify-content-center">
          ...
          <div class="card">
            <div class="card-header bg-primary text-white">
              <div class="row align-items-center">
                ...
                <div class="col-6">
                  <a href="/riwayat-pembayaran" type="button" class="btn btn-warning float-end">Menu Pembayaran</a>
                </div>
              </div>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Kode Pembayaran</h6>
                        </th>
                        <th class="border-bottom-0">
