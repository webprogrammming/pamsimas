                ...
                <td style="width: 50%; vertical-align: top;">
                    <table>
                        <tr>
                            ...
                            <td style="width: 5%;">:</td>
                            <td><strong>{{ $pemakaian->periode->periode }}</strong></td>
                        </tr>
                        <tr>
                            <td>No. ID</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>PAMDes</td>
                            <td>:</td>
                            <td>"SALING SEDOK"</td> <!-- Ganti sesuai field jika ada -->
                        </tr>
                        <tr>
                            <td>Meter Awal</td>
                            <td>:</td>
                            <td>{{ $pemakaian->penggunaan_awal }} M<sup>3</sup></td>
                        </tr>
                        <tr>
                            <td>Meter Akhir</td>
                            <td>:</td>
                            <td>{{ $pemakaian->penggunaan_akhir }} M<sup>3</sup></td>
                        </tr>
                        <tr>
                            <td>Status</td>
                            <td>:</td>
                            <td><strong>{{ $pemakaian->status }}</strong></td>
                        </tr>
                    </table>
                </td>
                ...
                <td style="width: 50%; vertical-align: top;">
                    <table>
                        <tr>
                            ...
                            <td style="width: 5%;">:</td>
                            <td>{{ $pemakaian->jumlah_penggunaan }} M<sup>3</sup></td>
                        </tr>
                        <tr>
                            <td>Total Tagihan Air</td>
                            <td>:</td>
                            <td>Rp. {{ number_format($tarif_m3 * $pemakaian->jumlah_penggunaan, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Beban</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Sampah</td>
                            <td>:</td>
                            <td>Rp. {{ number_format($sampah, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Sb. Masjid</td>
                            <td>:</td>
                            <td>Rp. {{ number_format($masjid, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Denda</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td style="color: red; font-weight: bold;">Rp. {{ number_format($subTotal, 0, ',', '.') }}
                            </td>
                        </tr>
                        <tr>
