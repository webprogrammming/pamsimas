            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="card-title fw-semibold text-white">Saldo Keluar</h5>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="/saldo-keluar/create" type="button" class="btn btn-warning float-end">Tambah
                                Saldo Keluar</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mt-5">
                        <div class="table-responsive">
                            <table id="table_id" class="table display">
                                ...
                                <tbody>
                                    @foreach ($SaldoKeluars as $history)
                                        <tr>
